<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16 pb-2">
            <div class="flex gap-2">
                <!-- Logo -->
                {{-- <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}"> --}}
                <img class="block fill-current text-gray-800 w-8 h-8 my-auto"
                    src="{{ asset('images/Nasr_Benghazi.png') }}" alt="logo">
                {{-- </a>
                </div> --}}

                <!-- Navigation Links -->
                <div class="gap-4 sm:-my-px sm:ml-10 sm:flex">
        ...
        {{ __('Dashboard') }}
                    ...
                    {{-- 
    @can('fullreportcouch')
        <x-nav-link :href="route('CouchPreformances')" :active="request()->routeIs('CouchPreformances')">
            {{ __(' تقارير المدربين') }}
        </x-nav-link>
    @endcan --}}
