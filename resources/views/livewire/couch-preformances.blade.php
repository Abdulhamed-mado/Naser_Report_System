                                                ...
                                                @can('fullAccessUser')
                                                    <div class="mb-4">
                                                        ...
                                                        <select wire:model="user_id" id="user_id" name="user_id"
                                                            ...
                                                            <option value="">اختر الاداري</option>
                                                            @foreach ($manegers as $maneger)
                                                                <option value="{{ $maneger->id }}">{{ $maneger->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                            ...
                            <table class="min-w-full divide-y divide-neutral-200">
                                <thead class="bg-neutral-50">
                                    <tr class="text-neutral-500">
                                        ...
                                        <th class="px-5 py-3 text-xs font-medium text-right ">اسم الاداري</th>
                                ...
                                <tbody class="divide-y divide-neutral-200">
                                    @foreach ($reports as $report)
                                        ...
                                        <tr class="text-neutral-800">
                                            ...
                                            <td class="px-5 py-4 text-sm whitespace-nowrap">{{ $report['user_name'] }}
                                            </td>
                                            <td class="px-5 py-4 text-sm whitespace-nowrap">{{ $report['attendance'] }}
                                            </td>
                                            <td class="px-5 py-4 text-sm whitespace-nowrap">{{ $report['performance'] }}
                                            </td>
                                                                        ...
                                                                        @can('fullAccessUser')
                                                                            <div class="mb-4">
                                                                                ...
                                                                                <select wire:model="user_id" id="user_id"
                                                                                    name="user_id"
                                                                                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                                                                                    <option value="">اختر الاداري
                                                                                    </option>
                                                                                    @foreach ($manegers as $maneger)
                                                                                        <option value="{{ $maneger->id }}">
                                                                                            {{ $maneger->name }}
                                                                                        </option>
                                                                                    @endforeach
                                                                                </select>
