                                    ...
                                    <div class="mt-3 text-center sm:mt-0 sm:text-left w-full">
                                        ...
                                        <div class="mt-2 text-right">
                                            <form>
                                                ...
                                                <div class="mb-4">
                                                    <label class="block text-gray-700 font-bold mb-2" for="matchType">
                                                        نوع المباراة </label>
                                                    <select wire:model="matchType" id="matchType" name="matchType"
                                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                                        dir="rtl">
                                                ...
                                                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                                    ...
                                                    <button
                                                        class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-black text-base font-medium text-white hover:bg-gray-800 focus:outlineLet me continue where I left off:-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 sm:ml-3 sm:w-auto sm:text-sm"
                                                        wire:click.prevent="addAnotherReport">
                                                        حفظ و اضافة عنصر اخر
                                                                    ...
                                                                    <form>
                                                                        ...
                                                                        <div class="mb-4">
                                                                            <label
                                                                                ...
                                                                                for="matchType">
                                                                                نوع المباراة </label>
                                                                            <select wire:model="matchType" id="matchType"
                                                                                name="matchType"
                                                                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                                                                dir="rtl">
                                                                                <option value="">اختر نوع المباراة
                                                                                </option>
